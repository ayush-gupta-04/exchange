'use client'
import { OrderHisoryType } from "@/utils/types";
        ...
        <div className="flex-1 flex flex-col">
            ...
            {orderHistory.length > 0 && 
                <div className="grid grid-cols-7 px-2 py-2 border-b-1 border-gray-700/[30%]">
                    ...
                    <div className="text-base-dim-text text-satrt">Side</div>
                    ...
                    <div className="text-base-dim-text text-end">Status</div>
                    <div className="text-base-dim-text text-end">Created</div>
                </div>
            }
            {orderHistory && orderHistory.map((order,id) => {
                ...
                return (
                    <div key={id} className="hover:bg-base-background-light2/[90%] grid grid-cols-7 border-b-1 border-gray-700/[30%] px-2 items-center py-4">
                        <div className="text-base-text-white font-semibold text-start text-sm ">{market}</div>
                        <div className="text-base-text-white font-semibold text-start text-sm">{order.side}</div>
                        <div className="text-base-text-white font-semibold text-end text-sm">{order.price}</div>
                        <div className="text-base-text-white font-semibold text-end text-sm">{order.qty}</div>
                        <div className="text-base-text-white font-semibold text-end text-sm">{(order.filled/order.qty)*100}%</div>
                        <div className="text-base-text-white font-semibold text-end text-sm">{order.status}</div>
                        <div className="text-base-text-white font-semibold text-end text-sm flex flex-col gap-1">
