...
export default function Markets(){
    return(
        <div className="min-h w-4/6 bg-base-background-light px-4 py-4 rounded-lg flex flex-col">
            <span className="bg-base-background-light2 px-2 py-1 rounded-lg text-white w-fit mb-4">
                Spot
            </span>
            <div className="grid grid-cols-5 text-gray-400 border-b-1 border-base-background-light2 pb-2">
